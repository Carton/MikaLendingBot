...
class TestOrchestrator:
    ...
    def test_orchestrator_initialization(self, mock_pm, mock_le, mock_api, mock_logger, mock_load_config):
    ...
    def test_orchestrator_step(self, mock_time, mock_stdout, mock_data):
