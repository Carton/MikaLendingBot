...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "settings.xdayAdd": "Add threshold",
    "settings.xdayAxisDays": "days",
    "settings.xdayAxisRate": "%/day",
    "settings.xdayDaysLabel": "Lending days",
    "settings.xdayDaysOrderError": "Days must not decrease as the rate increases",
    "settings.xdayDaysRequired": "Enter the lending days",
    "settings.xdayEmpty": "No thresholds configured: every offer uses the default 2-day duration.",
    "settings.xdayPreview": "Duration mapping preview",
    "settings.xdayPreviewHint": "Rates between thresholds are interpolated; rates outside the range use the first/last duration.",
    "settings.xdayRateLabel": "Daily rate",
    "settings.xdayRateRequired": "Enter the daily rate",
    "settings.xdayRemove": "Remove threshold",
    "settings.xdayTitle": "Lending duration thresholds",
    ...
    "table.noRecentLoans": "No recent loans",
    "table.recentLoans": "Recent Loans",
    "timespan.Day": "Day",
    "timespan.Hour": "Hour",
  ...
  "zh-CN": {
    ...
    "settings.seconds": "秒",
    "settings.title": "设置",
    "settings.xdayAdd": "添加阈值",
    "settings.xdayAxisDays": "天",
    "settings.xdayAxisRate": "%/天",
    "settings.xdayDaysLabel": "放贷天数",
    "settings.xdayDaysOrderError": "利率升高时天数不能减少",
    "settings.xdayDaysRequired": "请输入放贷天数",
    "settings.xdayEmpty": "未配置阈值：所有放贷使用默认 2 天期限。",
    "settings.xdayPreview": "期限映射预览",
    "settings.xdayPreviewHint": "相邻阈值之间的利率按线性插值；超出范围的利率使用首/末档天数。",
    "settings.xdayRateLabel": "日利率",
    "settings.xdayRateRequired": "请输入日利率",
    "settings.xdayRemove": "删除该档",
    "settings.xdayTitle": "放贷时长阈值",
    ...
    "table.noRecentLoans": "暂无最近借贷",
    "table.recentLoans": "最近借贷",
    "timespan.Day": "天",
    "timespan.Hour": "小时",
    "timespan.Month": "月",
    "timespan.Week": "周",
